      ...
      <main className="fees-page" style={{ paddingTop: '150px', paddingBottom: '100px', minHeight: '80vh' }}>
        <div className="section-container">
          ...
          <div style={{ maxWidth: '600px', margin: '0 auto', background: '#fff', borderRadius: '15px', padding: '30px', color: '#333' }}>
            <h2 style={{ color: 'var(--green)', marginBottom: '15px' }}>₹3,500 / term (Base)</h2>
            <p style={{ fontSize: '1.1rem', marginBottom: '20px' }}>Safe, GPS-tracked transportation across Budapadi and Erode areas.</p>
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li style={{ padding: '10px 0', borderBottom: '1px solid #eee' }}>✅ GPS Tracking App</li>
              <li style={{ padding: '10px 0', borderBottom: '1px solid #eee' }}>✅ Female Attendant on Board</li>
              <li style={{ padding: '10px 0' }}>✅ AC & Non-AC Options</li>
            </ul>
          </div>
        </div>
      </main>
