...
const classes = [
  ...
  { title: "Upper Primary (3–5)", icon: "ti-school", tag: "Ages 8–12", tagClass: "tag-orange", iconBg: "icon-green", body: "CBSE & ICSE aligned curriculum preparing students for middle school excellence." },
];
    ...
    <section id="academics" className="academics-section">
      <div className="section-container">
        <div className="section-header centered">
          ...
          <h2>CBSE & ICSE based<br />excellence, <span style={{ color: "var(--blue)" }}>every grade</span> 🎓</h2>
        ...
        <div className="syllabus-row">
          ...
          <div className="syllabus-badge badge-orange">✅ ICSE Based Syllabus</div>
        </div>
      </div>
    </section>
  );
